...
Route Planning Project based on A* search algorithm on OpenStreetMap Project
...
```
git clone https://github.com/iAbdulhamid/openstreetmap-route-planner-project.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:iAbdulhamid/openstreetmap-route-planner-project.git --recurse-submodules
```
